...
export class TimelineComponent {
  items: TimelineItem[] = [
    ...
    // },
    {
      type: 'event',
      year: 2168,
      title: 'Technosignatures Breakthrough',
      text: 'One hundred billion tons of freight are transported on Earth in one year. Two graduate researchers from UCLA successfully identify technosignatures, laying critical groundwork for practical interplanetary travel.',
      gap: 120
    },
    {
      type: 'event',
    ...
    },
    {
      type: 'event',
      year: 2200,
      title: `The Year 2100 and 'The Brand New Day' Plan`,
